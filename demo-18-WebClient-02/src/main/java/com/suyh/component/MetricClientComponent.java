...
public class MetricClientComponent {
    ...
    public void getMessage() {
        ...
        Mono<ResponseEntity<TempCommandResponse>> commandResponseMono01
                = this.client01.get()
                ...
                .retrieve()
                .toEntity(TempCommandResponse.class);

        Mono<ResponseEntity<TempCommandResponse>> commandResponseMono02
                = this.client02.get()
                .uri(uriBuilder -> uriBuilder.path("/gov/app/demo/actuator/arms-command-api/metric")
                        .queryParam("startTime", "" + startTime)
                        .queryParam("endTime", "" + endTime)
        ...
        Mono<ResponseEntity<TempCommandResponse>> commandResponseMono03
                = this.client03.get()
                .uri(uriBuilder -> uriBuilder.path("/gov/app/demo/actuator/arms-command-api/metric")
                        .queryParam("startTime", "" + startTime)
                        .queryParam("endTime", "" + endTime)
        ...
        Mono<ResponseEntity<TempCommandResponse>> commandResponseMono04
                = this.client04.get()
                .uri(uriBuilder -> uriBuilder.path("/gov/app/demo/actuator/arms-command-api/metric")
                        .queryParam("startTime", "" + startTime)
                        .queryParam("endTime", "" + endTime)
        ...
        // 将其合并到一起
        Flux<ResponseEntity<TempCommandResponse>> mergeFlux = Flux.merge(
